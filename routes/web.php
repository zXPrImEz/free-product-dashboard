...
Route::get('resources', fn() => view('resources.main'))->middleware(['auth'])->name('resources');

Route::get('resources/{id}', '\App\Http\Controllers\ResourceController@show')->middleware(['auth'])->name('resources.view');
Route::post('resources/{id}/update', '\App\Http\Controllers\KeyController@update')->middleware(['auth']);

Route::post('redeem', '\App\Http\Controllers\RedeemController@store')->middleware(['auth'])->name('redeem');
Route::get('redeem', fn() => view('redeem'))->middleware(['auth'])->name('redeem');
// #endregion

// #region ADMIN SECTION

Route::get('admin/resources', fn() => view('admin.resources'))->middleware(['auth', 'role:admin'])->name('admin.resources');
Route::post('admin/resources', '\App\Http\Controllers\ResourceController@store')->middleware('role:admin');
Route::delete('admin/resources/{id}', '\App\Http\Controllers\ResourceController@destroy')->middleware(['auth', 'role:admin'])
    ->name('admin.resources.delete');
Route::get('admin/resources/{id}/download', '\App\Http\Controllers\ResourceController@download')->middleware('role:admin')
    ->name('admin.resources.download');

Route::get('admin/keys', fn() => view('admin.keys'))->middleware(['auth', 'role:admin'])->name('admin.keys');
Route::post('/admin/keys', '\App\Http\Controllers\KeyController@store')->middleware(['auth', 'role:admin']);
Route::post('/admin/keys/import', '\App\Http\Controllers\KeyController@import')->middleware(['auth', 'role:admin']);
Route::delete('/admin/keys/{id}', '\App\Http\Controllers\KeyController@destroy')->middleware(['auth', 'role:admin'])->name('admin.keys.delete');

Route::get('admin/users', fn() => view('admin.users'))->middleware(['auth', 'role:admin'])->name('admin.users');
// #endregion
