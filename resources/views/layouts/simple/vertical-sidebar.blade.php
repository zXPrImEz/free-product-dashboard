            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li class=" customizer-color"><a href="{{route('/')}}">Boxed</a></li>
                            <li class=" customizer-color"><a href="{{route('/')}}">RTL</a></li>
                            <li class=" customizer-color dark"><a href="{{route('/')}}">Dark Layout</a></li>
                            <li class=" customizer-color"><a href="{{route('/')}}">Hide Nav Scroll</a></li>
                            <li class=" customizer-color"><a href="{{route('/')}}">Footer Light</a></li>
                            <li class=" customizer-color"><a href="{{route('/')}}">Footer Dark</a></li>
                            <li class=" customizer-color"><a href="{{route('/')}}">Footer Fixed</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{route('calendar-basic')}}"><i data-feather="calendar"> </i><span>{{ trans('lang.Calendar') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{ route('search') }}"><i data-feather="search"> </i><span>{{ trans('lang.Search Result') }}</span></a>
                    </li>
                    <li class="sidebar-main-title">
                        <div>
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{route('sample-page')}}"><i data-feather="file-text"> </i><span>{{ trans('lang.Sample page') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='internationalization' ? 'active' : '' }}"
                            href="{{route('internationalization')}}"><i data-feather="globe"> </i><span>{{ trans('lang.Internationalization') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='layout-light' ? 'active' : '' }}"
                            href="{{ route('layout-light') }}" target="_blank"><i data-feather="anchor"></i><span>{{ trans('lang.Starter kit') }}</span></a>
                    </li>
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{ route('knowledgebase') }}"><i data-feather="sunrise"> </i><span>{{ trans('lang.Knowledgebase') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='support-ticket' ? 'active' : '' }}"
                            href="{{route('support-ticket')}}"><i data-feather="users"> </i><span>{{ trans('lang.Support Ticket') }}</span></a>
                    </li>
                </ul>
            </div>
