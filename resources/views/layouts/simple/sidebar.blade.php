                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-main-title">
                        <div>
                            ...
                            <p class="lan-2">User Area</p>
                        </div>
                    </li>
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='/' ? 'active' : '' }}"
                           href="{{route('/')}}">
                    ...
                    <li class="sidebar-list">
                        <label
                            class="badge badge-light-primary">{{ \App\Models\Key::all()->where('owner_id', auth()->user()->id)->count() }}</label>
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='resources' ? 'active' : '' }}"
                           href="{{route('resources')}}" data-bs-original-title="" title="">
                            <i data-feather="folder"></i><span>Resources</span>
                        </a>
                    </li>
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='redeem' ? 'active' : '' }}"
                           href="{{route('redeem')}}" data-bs-original-title="" title="">
                            <i data-feather="clipboard"></i><span>Redeem</span>
                        </a>
                    </li>
                    <!-- END USER AREA -->
                    <!-- START EXTERNAL AREA -->
                    ...
                    <li class="sidebar-main-title">
                        <div>
                            <h6 class="lan-1">External</h6>
                            <p class="lan-2">External Links</p>
                        </div>
                    </li>

                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav"
                           href="https://discord.gg/xbx" data-bs-original-title="" title="">
                            <i data-feather="link"></i><span>Discord</span>
                        </a>
                    </li>
                    <!-- END EXTERNAL AREA -->
                    ...
                    <li class="sidebar-main-title">
                        <div>
                            <h6 class="lan-1">Management</h6>
                            <p class="lan-2">Management Area</p>
                        </div>
                    </li>

                    <li class="sidebar-list">
                        <label class="badge badge-light-primary">{{ \App\Models\Key::all()->count() }}</label>
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='admin.keys' ? 'active' : '' }}"
                           href="{{route('admin.keys')}}" data-bs-original-title="" title="">
                            <i data-feather="database"></i><span>Keys</span>
                        </a>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-primary">{{ \App\Models\Resource::all()->count() }}</label>
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='admin.resources' ? 'active' : '' }}"
                           href="{{route('admin.resources')}}" data-bs-original-title="" title="">
                            <i data-feather="box"></i><span>Resources</span>
                        </a>
                    </li>
                    <li class="sidebar-list">
                        <label class="badge badge-light-primary">{{ \App\Models\User::all()->count() }}</label>
                        <a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='admin.users' ? 'active' : '' }}"
                           href="{{route('admin.users')}}" data-bs-original-title="" title="">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu"
                            ...
                            <li><a href="{{route('pagebuild')}}"
                                   class="{{ Route::currentRouteName()=='pagebuild' ? 'active' : '' }}">Page Builder</a>
                            </li>
                        ...
                        <ul class="sidebar-submenu"
                            ...
                            <li><a href="{{route('scroll-reval')}}"
                                   class="{{ Route::currentRouteName()=='scroll-reval' ? 'active' : '' }}">Scroll
                                    Reveal</a></li>
                            <li><a href="{{route('aos')}}"
                                   class="{{ Route::currentRouteName()=='aos' ? 'active' : '' }}">AOS animation</a></li>
                            <li><a href="{{route('tilt')}}"
                                   class="{{ Route::currentRouteName()=='tilt' ? 'active' : '' }}">Tilt Animation</a>
                            </li>
                            <li><a href="{{route('wow')}}"
                                   class="{{ Route::currentRouteName()=='wow' ? 'active' : '' }}">Wow Animation</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{route('landing-page')}}"><i
                                data-feather="cast"> </i><span>{{ trans('lang.Landing Page') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='sample-page' ? 'active' : '' }}"
                            href="{{route('sample-page')}}"><i
                                data-feather="file-text"> </i><span>{{ trans('lang.Sample page') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='internationalization' ? 'active' : '' }}"
                            href="{{route('internationalization')}}"><i
                                data-feather="globe"> </i><span>{{ trans('lang.Internationalization') }}</span></a>
                    </li>
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{route('faq')}}"><i
                                data-feather="help-circle"> </i><span>{{ trans('lang.FAQ') }}</span></a></li>
                    <li class="sidebar-list">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu"
                            ...
                            <li><a href="{{route('vector-map')}}"
                                   class="{{ Route::currentRouteName()=='vector-map' ? 'active' : '' }}">Vector Maps</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu"
                            ...
                            <li><a href="{{route('summernote')}}"
                                   class="{{ Route::currentRouteName()=='summernote' ? 'active' : '' }}">Summer Note</a>
                            </li>
                    ...
                    <li class="sidebar-list"><a
                            ...
                            href="{{ route('knowledgebase') }}"><i
                                data-feather="sunrise"> </i><span>{{ trans('lang.Knowledgebase') }}</span></a>
                    </li>
                    <li class="sidebar-list"><a
                            class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='support-ticket' ? 'active' : '' }}"
                            href="{{route('support-ticket')}}"><i
                                data-feather="users"> </i><span>{{ trans('lang.Support Ticket') }}</span></a>
                    </li>
                    <!-- TODO: END COMMENT -->
